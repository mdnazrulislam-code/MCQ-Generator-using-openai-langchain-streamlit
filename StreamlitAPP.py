...
with open("E:\Generative AI\MCQ-Generator-using-openai-langchain-streamlit\Response.json", "r") as file:
...
with st.form("user_inputs"):
    ...
    #Subject
    subject = st.text_input("Enter the Subject name", max_chars=30)
    ...
    if button and uploaded_file is not None and mcq_count and subject and tone:
        with st.spinner("loading....."):
            try:
                ...
                #Count the token and the cost of the API
